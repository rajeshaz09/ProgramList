...
namespace ProgramList.Infragistics.ViewModels
{
    ...
    internal class DateTimeColumnInfo : IColumnInfo
    {
        private string v1;
        private Type type;
        private bool v2;
        ...
        public DateTimeColumnInfo(string v1, Type type, bool v2, bool v3, bool v4, bool v5)
        {
            this.v1 = v1;
            this.type = type;
            this.v2 = v2;
    ...
    internal class ButtonColumnInfo : IColumnInfo
    {
        private string v1;
        private Type type;
        ...
        public ButtonColumnInfo(string v1, Type type, ICommand command, bool v2, bool v3, bool v4, bool v5)
        {
            this.v1 = v1;
            this.type = type;
    ...
    internal class DropDownColumnInfo : IColumnInfo
    {
        private string v1;
        private Type type;
        private DropDownItemCollection dropDownDataSource;
        private bool v2;
        private bool v3;
        private bool v4;
        private bool v5;

        public DropDownColumnInfo(string v1, Type type, DropDownItemCollection dropDownDataSource, bool v2, bool v3, bool v4, bool v5)
        {
            this.v1 = v1;
            this.type = type;
    ...
    internal class ColumnInfo : IColumnInfo
    {
        ...
        public ColumnInfo(string v1, Type type, bool v2, bool v3, bool v4, bool v5)
        {
            this.v1 = v1;
            this.type = type;
            this.v2 = v2;
