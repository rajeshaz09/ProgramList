...
namespace ProgramList.POC.Models
{
    public class CustomTypeProviderType : Type
    {
        ...
        private List<CustomTypeProviderPropertyInfo> customProperties;

        public CustomTypeProviderType(Type delegatingType, List<CustomTypeProviderPropertyInfo> properties)
        {
