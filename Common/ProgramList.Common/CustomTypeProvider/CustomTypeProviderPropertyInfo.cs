...
{
    public class CustomTypeProviderPropertyInfo : PropertyInfo
    {
        ...
        public CustomTypeProviderPropertyInfo(string name, Type type, Type ownerType)
        {
            _name = name;
            _type = type;
        ...
        public CustomTypeProviderPropertyInfo(string name, Type type, List<Attribute> attributes, Type propertyOwner)
        {
            _name = name;
            _type = type;
