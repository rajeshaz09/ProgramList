...
namespace ProgramList.TelerikPOC.ViewModels
{
    public static class ProgramListViewModelHelper
    {
        ...
        internal static void ClearAndAssignData(ProgramListViewModelBase viewModel)
        {
            AssignData(viewModel, true);
        }

        private static int seed = 0;
        public static void AssignData(ProgramListViewModelBase viewModel, bool ClearOld = false)
        {
